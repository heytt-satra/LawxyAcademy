  ...
  credentials: [
    {
      ...
      skills: [
        ...
        'LLM Understanding & Context Optimization',
        'Defensive Legal Prompt Engineering',
        'AI-Assisted Legal Research (JurisMind)',
        'Contract Analysis & Playbook Redlining',
        'Litigation Fact Matrix Reconstruction (Case Lens)',
        'Multi-Step Legal Workflow Orchestration (AgentFlow)',
      ...
      specializations: ['Litigation Workflows'],
    ...
    },
    {
      ...
      email: 'marcus.vance@inhouse-counsel.com',
      certificationCode: 'AINL-L2',
      title: 'Lawxy Certified AI-Native Lawyer (Advanced Practice)',
      level: 2,
      status: 'active',
      issuedAt: '2026-02-01T09:30:00Z',
      expiresAt: '2028-02-01T09:30:00Z',
      scorePercentage: 96.8,
      skills: [
        'Advanced Legal Research & Brief Auditing',
        'High-Throughput Contract Diligence Pipelines',
        'Autonomous Legal Agent Orchestration',
        'Enterprise AI Governance & Risk Policies',
        'Proprietary Legal Knowledge Graph & Custom RAG'
      ],
      specializations: ['Transactional AI Diligence', 'Legal Ops Automation'],
      verificationUrl: '/verify/LXY-AINL-2026-000042',
      auditHash: '39bb481e194857201cba68294719e09d123851aa7f920bc881d4590ef491024bd'
    }
  ],
